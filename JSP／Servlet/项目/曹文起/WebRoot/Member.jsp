...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    function wodedingdan() {
    	alert("xxx");
		jq.getJSON("servlet/AdminUserServlet","pro=wodedingdan",function(json){
			jq(".m_right").empty();
			jq(".m_right").append(
					"<p></p>"+
				      "<p></p>"+
				     " <div class='mem_tit'>订单列表</div>"+
				      "<table border='0' class='order_tab' style='width:930px; text-align:center; margin-bottom:30px;' cellspacing='0' cellpadding='0'>"+
				       " <tbody>"+
				          ...
				          "<tr class='td_bg'>"+
				           " <td>用户名:"+json.name+"</td>"+
				           " <td><a href='#'>订单号:"+json.dingdanhao+"</a></td>"+
				            "<td>地址:"+json.dizi+"</td>"+
				           " <td>￥"+json.money+"</td>"+
				          "</tr>"+
				          "<tr>"+
				          ...
				          "<tr>"+
				            "<td colspan='4'>"+
				              "<table border='0' id='qwer' class='order_tab' style='width:930px; text-align:center; margin-bottom:30px;' cellspacing='0' cellpadding='0'>"+
				               " <tbody>"+
				               " <tr>"+
				                 " <td width='20%'>商品名称</td>"+
				                 " <td width='20%'>商品图片</td>"+
				...
				jq("#qwer").append(
						...
						" <tr>"+
		                  "  <td>"+v.name+"</td>"+
		                   " <td>"+
		                     " <a href='#'>"+
		                      "  <img src='images/"+v.fileName+"' width='50' height='50'>"+
		                   "   </a>"+
		                   " </td>"+
		                    "<td>"+v.num+"</td>"+
		                    "<td>"+v.money+"</td>"+
...
<div class="soubg">
	<div class="sou">
       ...
       <span class="fr"> 
			...
			<span>&nbsp;<a href="servlet/UserServlet?&&pro=zx">注销</a></span>
			</span>
    </div>
</div>
<div class="m_top_bg">
...
<div class="i_bg bg_color">
    ...
    <div class="left_m">
        ...
        <ul>
            <li><a href="#" onclick="wodedingdan()">我的订单</a></li>
