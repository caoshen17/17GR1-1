...
function jiarugouwuche(id){
	...
	$.getJSON("servlet/ProductServlet","pro=cxwpxx&id="+id,function(json){
		$("#gouwunum").html(num);
		var money=$("#zongjine").text();
		$("#zongjine").html(parseInt(money)+parseInt(json.price));
		$(".cars").append("<li>"+
				"<div class='img'>"+
					"<a href='#'><img src='images/"+json.fileName+"' width='58' height='58' /></a>"+
				"</div>"+
				"<div class='name'>"+
					"<a href='#'>"+json.name+"</a>"+
				"</div>"+
...
<body>
	...
	<div class="soubg">
		<div class="sou">
			...
			<span class="fl"><a href="Member.jsp">系统管理员</a>&nbsp;|</span>
				</c:if> 
	...
	<div class="top">
		...
		<div class="i_car">
			<div class="car_t">
				...
				<c:if test="${empty sessionScope.listgouwuche}">
				<script>
				location.href="servlet/ProductServlet?&&pro=cshgwc";
				</script>
				</c:if>
				<c:set value="${fn:length(sessionScope.listgouwuche)}" var="qqq">
				</c:set>
				<span id="gouwunum">
				<c:forEach items="${sessionScope.listgouwuche}" var="xx">
				<c:if test="${xx.id=='999999999'}">
			...
			<div class="car_bg">
				...
				<c:set value="0" var="num"></c:set>
					<c:forEach items="${sessionScope.listgouwuche}" var="xiao">
					<c:if test="${xiao.id=='999999999'}">
					</c:if>
					<c:if test="${xiao.id!='999999999'}">
					<c:set value="${num+xiao.price}" var="num" />  
					<li>
						<div class="img">
							<a href="#"><img src="images/${xiao.fileName}" width="58" height="58" /></a>
						</div>
						<div class="name">
							<a href="#">${xiao.name}</a>
						</div>
						<div class="price">
							<font color="#ff4e00">￥${xiao.price}</font> X1
						</div>
					</li>
					</c:if>
					</c:forEach>
			...
			<div class="nav">
				...
				<div class="leftNav">
                   ...
                   for(ProductCategoryVo yiji:queryAllProductCategoryList){
                	   %>
						<li><div class="fj">
								<span class="n_img"> <img src="images/nav<%=i%>.png" /></span> <span
